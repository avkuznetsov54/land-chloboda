				...
				<div class="row">
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="fflats__thumbnail">
							...
							<div class="fflats__thumbnail-button">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-8 offset-md-2">
						<span class="request__body-declaration">Нажимая на кнопку «позвоните мне»,<br> Вы соглашаетесь на обработку <a href="http://www.sasn.ru/about/personaldata/" target="_blank">персональных данных</a></span>
					</div>
				</div>
			</div>
		</div>
